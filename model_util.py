...
class BaseMethod:
    ...
    def get_sub_module_by_model_idx_all(self, model_idxs: Set[int]):
        ...
        for model_idx in model_idxs:
            ...
            sub_model_idx.append(models)
        return sub_model_idx

    def get_model_structure(self, sub_model):
        model_structure = self.require_sub_model_all[sub_model]
    ...
    def __init__(self):
        ...
        self.latency = [
            [  # 2
                [0.135990858, ] * 10,
                [0.201506972, ] * 10,
                [0.194757056, 0.045601606, 0.043881512, 0.042294717, 0.041257095, 0.040289712, 0.041384459, 0.04009223,
                 0.042858768, 0.039830589],
                [0.181886792, 0.044860005, 0.0440382, 0.042821765, 0.041881132, 0.039645624, 0.042106056, 0.041171479,
                 0.03931706, 0.04142592]
            ],
            [  # 3
                [0.13459971, ] * 10,
                [0.204626083, ] * 10,
                [0.189062619, 0.048365259, 0.043605471, 0.04241128, 0.041698623, 0.041868114, 0.041815138, 0.040962243,
                 0.041610646, 0.039768434],
                [0.182476449, 0.044616342, 0.043532491, 0.043518043, 0.040133238, 0.040185833, 0.041477394, 0.040636206,
                 0.039343548, 0.041982532]
            ],
            [  # 4
                [0.152732325, ] * 10,
                [0.201511741, ] * 10,
                [0.204985499, 0.042389655, 0.040116858, 0.038677812, 0.039412808, 0.037670755, 0.038818765, 0.038382888,
                 0.038452697, 0.03672843],
                [0.195576763, 0.040828538, 0.03947804, 0.039878082, 0.038290191, 0.038246274, 0.038030124, 0.037859988,
                 0.036315417, 0.037552762]
            ],
            [  # 5
                [0.137135577, ] * 10,
                [0.1890131, ] * 10,
                [0.19721477, 0.040685987, 0.039271116, 0.037487793, 0.036696982, 0.036797166, 0.035172009, 0.035724592,
                 0.035730457, 0.034275293],
                [0.18819325, 0.041623545, 0.038406134, 0.037783098, 0.036522651, 0.036203599, 0.036601329, 0.03701334,
